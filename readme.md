...
4.  A **time series plot** that gives you a line of one or two events over time. This one also needs some work.
...
**timeseries(in_dates, events, labels = ["", ""], title="", numticks=3, labelsize=12, size=(10, 10), font="Lato")**
